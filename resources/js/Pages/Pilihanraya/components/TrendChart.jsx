            ...
            {data.length === 0 ? (
                ...
                <ResponsiveContainer width="100%" height={height}>
                    <AreaChart data={data}>
                        ...
                        <Area type="monotone" dataKey="putih_pct" name="PH (Putih)" stroke="#475569" strokeWidth={3} fillOpacity={1} fill="url(#gradPutih)" dot={{ r: 3, fill: '#ffffff', stroke: '#475569', strokeWidth: 1.5 }} activeDot={{ r: 5, fill: '#ffffff', stroke: '#475569', strokeWidth: 2 }} />
