...
export default function Edit({
    ...
    const { data, setData, post, processing, errors } = useForm({
        ...
        status_sumbangan: hasilCulaan.status_sumbangan || '',
        tarikh_sumbangan: (hasilCulaan.tarikh_sumbangan || '').slice(0, 10),
        jumlah_dipohon: hasilCulaan.jumlah_dipohon || '',
        jumlah_dilulus: hasilCulaan.jumlah_dilulus || '',
        jumlah_dibayar: hasilCulaan.jumlah_dibayar || '',
    ...
    useEffect(() => {
        if (data.no_ic.length === 12 && data.no_ic !== hasilCulaan.no_ic) {
