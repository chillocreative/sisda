...
<head>
    ...
    <title>Akses Ditolak - SISDA</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .particle:nth-child(1) { width: 300px; height: 300px; top: -10%; left: -5%; animation-duration: 25s; background: rgba(244, 63, 94, 0.08); }
        .particle:nth-child(2) { width: 200px; height: 200px; top: 60%; right: -5%; animation-duration: 20s; animation-delay: -5s; background: rgba(251, 146, 60, 0.06); }
        ...
        .glow-ring { position: absolute; width: 500px; height: 500px; border-radius: 50%; border: 1px solid rgba(244, 63, 94, 0.1); top: 50%; left: 50%; transform: translate(-50%, -50%); animation: pulse-ring 4s ease-in-out infinite; }
        .glow-ring::after { content: ''; position: absolute; inset: 30px; border-radius: 50%; border: 1px solid rgba(251, 146, 60, 0.08); animation: pulse-ring 4s ease-in-out infinite reverse; }
        ...
        .icon-wrapper { display: inline-flex; align-items: center; justify-content: center; width: 120px; height: 120px; border-radius: 50%; background: linear-gradient(135deg, rgba(244, 63, 94, 0.1), rgba(251, 146, 60, 0.1)); backdrop-filter: blur(10px); border: 1px solid rgba(255, 255, 255, 0.1); margin-bottom: 2rem; animation: icon-breathe 3s ease-in-out infinite; }
        @keyframes icon-breathe { 0%, 100% { box-shadow: 0 0 30px rgba(244, 63, 94, 0.1), 0 0 60px rgba(251, 146, 60, 0.05); } 50% { box-shadow: 0 0 50px rgba(244, 63, 94, 0.2), 0 0 100px rgba(251, 146, 60, 0.1); } }
        .icon-wrapper svg { width: 48px; height: 48px; color: #f43f5e; }
        .error-code { font-size: 5rem; font-weight: 700; background: linear-gradient(135deg, #f43f5e, #fb923c, #f43f5e); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text; line-height: 1; margin-bottom: 0.5rem; animation: gradient-shift 6s ease-in-out infinite; background-size: 200% 200%; }
        ...
        .btn-primary { background: linear-gradient(135deg, #f43f5e, #fb923c); color: white; border: none; box-shadow: 0 4px 15px rgba(244, 63, 94, 0.3); }
...
<body>
    ...
    <div class="container">
        ...
        <p class="description">{{ $exception->getMessage() ?: 'Anda tidak mempunyai kebenaran untuk mengakses halaman ini.' }}</p>
        <div class="btn-group">
