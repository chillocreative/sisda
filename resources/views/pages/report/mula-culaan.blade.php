      ...
      <div class="card-body">
        <div class="row">
          <div class="col-lg-8">
            <form action="{{ route('report-mula-culaan') }}" method="GET">
              <div class="row">
                ...
                <div class="col-lg-4 mt-3 mt-lg-0">
                  <button class="btn btn-primary btn-rounded btn-block">Filter</button>
                </div>
              </div>
            </form>
          </div>
          <div class="col-lg-4 mt-3 mt-lg-0">
            ...
            <a href="{{ route('export-excel-mula-culaan') }}" class="btn btn-danger">Export PDF</a>
          </div>
        </div>
        <hr>
