                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 form-group">
                                            ...
                                            <input type="number" name="no_kad[]" id="no_kad"
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 form-group">
                                            <label for="poskod" class="form-control-label">Poskod<span
                                                    class="text-danger"> *</span></label>
                                            <input type="text" name="poskod[]" id="poskod" pattern="\d*" maxlength="5"
