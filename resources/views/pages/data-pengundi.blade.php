        ...
        <div class="card-body">
          ...
          @csrf
              ...
              <div class="row">
                <div class="col-lg-6">
                  ...
                  <div class="row">
                    <div class="col-lg-6 form-group">
                      ...
                      <input type="number" name="no_kad[]" id="no_kad" class="form-control text-uppercase @error('no_kad') is-invalid @enderror no_kad" data-id="0" required>
                    ...
                    <div class="col-lg-6 form-group form-umur d-none" id="form-umur" data-id="0">
                      ...
                      <div class="input-group">
                        <input name="umur[]" id="umur" class="form-control umur" data-id="0" value="" readonly>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="phone[]" id="phone" class="form-control text-uppercase @error('phone') is-invalid @enderror" value="{{ old('phone') }}" required>
                ...
                <div class="col-lg-6">
                  <div class="form-group">
                    ...
                    <textarea name="alamat2[]" id="alamat2" rows="2" class="form-control text-uppercase mt-3">{{ old('alamat2') }}</textarea>
                  </div>
                  <div class="row">
                    <div class="col-lg-4 form-group">
                      <label for="poskod" class="form-control-label">Poskod<span class="text-danger"> *</span></label>
                      <input type="text" name="poskod[]" id="poskod" pattern="\d*" maxlength="5" class="form-control @error('no_telp') is-invalid @enderror" value="{{ old('poskod') }}"  required>
                    ...
                    <div class="col-md-4 form-group">
                      ...
                      <select name="negeri[]" id="negeri" class="form-control py-0 negeri" data-id="0" required>
                    ...
                    <div class="col-md-4 form-group">
                      ...
                      <select name="bandar[]" id="bandar" class="form-control py-0 bandar" data-id="0" disabled required>
                  ...
                  <div class="row">
                    <div class="col-md-6 form-group">
                      ...
                      <select name="parlimen[]" id="parlimen" class="form-control py-0 parlimen" data-id="0" disabled required>
                    ...
                    <div class="col-md-6 form-group">
                      ...
                      <select name="kadun[]" id="kadun" class="form-control py-0 kadun" data-id="0" disabled required>
                  ...
                  <div class="old-validate d-none" data-id="0">
                    <div class="form-group">
                      ...
                      <select id="keahlian_partai" name="keahlian_partai[]" class="form-control keahlian-partai py-1" data-id="0">
                    ...
                    <div class="form-group">
                      ...
                      <select id="kecenderungan_politik" name="kecenderungan_politik[]" class="form-control kecenderungan-politik py-1" data-id="0">
            ...
            <div class="form-group">
              <div class="row">
                <div class="col-lg-4">
                  <button type="button" class="btn btn-primary btn-block btn-rounded"><i class="fa fa-plus"></i> Tambah Isi Rumah</button>
                </div>
              </div>
            </div>
            <div class="form-group">
