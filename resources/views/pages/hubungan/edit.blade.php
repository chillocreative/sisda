...
@section('content')
  <a href="{{ route('hubungan.index') }}" class="btn btn-sm btn-secondary btn-rounded"><i class="fa fa-arrow-left"></i> <span class="ml-2">Kembali</span></a>
  <div class="row mt-3">
    <div class="col-lg-4">
      <div class="card">
        <div class="card-body">
          ...
          @method('PUT')
            <div class="form-group mt-3">
              ...
              <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" value="{{ $hubungan->name }}">
