                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 form-group">
                                                ...
                                                <input type="text" maxlength="12" name="no_kad" id="no_kad"
                                                    class="form-control text-uppercase @error('no_kad') is-invalid @enderror no_kad"
                                                    data-id="{{ $loop->iteration - 1 }}" oninput="nextHomeSectionAdd(this)" onchange="nextSection()" value={{ $item->no_kad }} required>
                                                @error('no_kad') <small
                                            ...
                                            <div class="col-lg-6 form-group form-umur" id="form-umur" data-id="{{ $loop->iteration - 1 }}">
                                                ...
                                                <div class="input-group">
                                                    <input name="umur" id="umur" class="form-control umur" data-id="{{ $loop->iteration - 1 }}"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 form-group">
                                                <label for="negeri" class="form-control-label">Negeri<span
                                                        class="text-danger"> *</span></label>
                                                <select name="negeri" id="negeri" class="form-control py-0 negeri" data-id="{{ $loop->iteration - 1 }}"
                                                    required>
                                            ...
                                            <div class="col-md-4 form-group">
                                                ...
                                                <select name="bandar" id="bandar" class="form-control py-0 bandar" data-id="{{ $loop->iteration - 1 }}"
                                                    required>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 form-group">
                                                ...
                                                <select name="parlimen" id="parlimen" class="form-control py-0 parlimen"
                                                    data-id="{{ $loop->iteration - 1 }}" required>
                                            ...
                                            <div class="col-md-6 form-group">
                                                <label for="kadun" class="form-control-label">KADUN<span class="text-danger">
                                                        *</span></label>
                                                <select name="kadun" id="kadun" class="form-control py-0 kadun" data-id="{{ $loop->iteration - 1 }}"
                                                required>
                                            ...
                                            @if($item->keahlian_partai)
                                                <div class="form-group">
                                                    ...
                                                    <select id="keahlian_partai" name="keahlian_partai"
                                                        class="form-control keahlian-partai py-1" data-id="{{ $loop->iteration - 1 }}" required>
                                                        <option value="" selected disabled>Pilih Keahlian Parti</option>
                                                        @foreach ($keahlianPartai as $k)
                                                            <option value="{{ $k->name }}" {{ $k->name === $item->keahlian_partai ? 'selected' : '' }}>{{ Str::upper($k->name) }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            @if($item->kecenderungan_politik)
                                                <div class="form-group">
                                                    ...
                                                    <select id="kecenderungan_politik" name="kecenderungan_politik"
                                                        class="form-control kecenderungan-politik py-1" data-id="{{ $loop->iteration - 1 }}" required>
                                                        <option value="" selected disabled>Pilih Kecenderungan Politik</option>
                                                        @foreach ($kecenderunganPolitik as $k)
                                                            <option value="{{ $k->name }}" {{ $k->name === $item->kecenderungan_politik ? 'selected' : '' }}>{{ Str::upper($k->name) }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 form-group">
                                            ...
                                            <input type="text" maxlength="12" name="no_kad" id="no_kad"
                                                class="form-control text-uppercase @error('no_kad') is-invalid @enderror no_kad"
                                                data-id="{{ $draft->count() > 0 ? $draft->count() : 0 }}" oninput="nextHomeSectionAdd(this)" onchange="nextSection()" required>
                                            @error('no_kad') <small
                                                class="text-danger">{{ $message }}</small>@enderror
                                        </div>
                                        <div class="col-lg-6 form-group form-umur d-none" id="form-umur" data-id="{{ $draft->count() > 0 ? $draft->count() : 0 }}">
                                            <label for="umur" class="form-control-label">Umur</label>
                                            <div class="input-group">
                                                <input name="umur" id="umur" class="form-control umur" data-id="{{ $draft->count() > 0 ? $draft->count() : 0 }}"
                                                    value="" readonly>
                                                <div class="input-group-prepend">
                                                    <div class="input-group-text">Tahun</div>
                                                </div>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 form-group">
                                            <label for="negeri" class="form-control-label">Negeri<span
                                                    class="text-danger"> *</span></label>
                                            <select name="negeri" id="negeri" class="form-control py-0 negeri" data-id="{{ $draft->count() > 0 ? $draft->count() : 0 }}"
                                                required>
                                        ...
                                        <div class="col-md-4 form-group">
                                            ...
                                            <select name="bandar" id="bandar" class="form-control py-0 bandar" data-id="{{ $draft->count() > 0 ? $draft->count() : 0 }}"
                                                disabled required>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 form-group">
                                            <label for="parlimen" class="form-control-label">Parlimen<span
                                                    class="text-danger"> *</span></label>
                                            <select name="parlimen" id="parlimen" class="form-control py-0 parlimen"
                                                data-id="{{ $draft->count() > 0 ? $draft->count() : 0 }}" disabled required>
                                                <option value="" disabled selected>Pilih Negeri dulu</option>
                                            </select>
                                            @error('kadun') <small
                                                class="text-danger">{{ $message }}</small>@enderror
                                        ...
                                        <div class="col-md-6 form-group">
                                            <label for="kadun" class="form-control-label">KADUN<span class="text-danger">
                                                    *</span></label>
                                            <select name="kadun" id="kadun" class="form-control py-0 kadun" data-id="{{ $draft->count() > 0 ? $draft->count() : 0 }}"
                                                disabled required>
                                    ...
                                    <div class="old-validate d-none" data-id="{{ $draft->count() > 0 ? $draft->count() : 0 }}">
                                        <div class="form-group">
                                            ...
                                            <select id="keahlian_partai" name="keahlian_partai"
                                                class="form-control keahlian-partai py-1" data-id="{{ $draft->count() > 0 ? $draft->count() : 0 }}">
                                                <option value="" selected disabled>Pilih Keahlian Parti</option>
                                                @foreach ($keahlianPartai as $k)
                                        ...
                                        <div class="form-group">
                                            <label for="kecenderungan-politik" class="form-control-label">Kecenderungan
                                                Politik<span class="text-danger"> *</span></label>
                                            <select id="kecenderungan_politik" name="kecenderungan_politik"
                                                class="form-control kecenderungan-politik py-1" data-id="{{ $draft->count() > 0 ? $draft->count() : 0 }}">
                                                <option value="" selected disabled>Pilih Kecenderungan Politik</option>
                                                @foreach ($kecenderunganPolitik as $k)
                                                    <option value="{{ $k->name }}">{{ Str::upper($k->name) }}
                                                    </option>
...
@section('script')
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            //     const custom = $('#hubungan-custom')[id]
